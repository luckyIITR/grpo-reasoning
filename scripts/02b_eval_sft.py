...
if __name__ == "__main__":
    ...
    # Baseline (no adapter)
    print("=== Baseline ===")
    base = load_model_with_adapter(model_cfg, adapter_path=None, trainable=False)
    ...
    # SFT
    print("=== SFT ===")
    sft = load_model_with_adapter(model_cfg, adapter_path="checkpoints/sft", trainable=False)
